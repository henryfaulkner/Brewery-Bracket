    ...
    return (
        <div className={styles.pageBackdrop}>
            ...
            <div className={styles.loginModal}>
                ...
                <img className={styles.logoImage} src="/Frothy-Beer.jpg" alt="Frothy Beer" />
                <input placeholder="Username" id="username"/>
                <input placeholder="Password" id="password"/>
                <button className={styles.loginButton} onClick={tryLogin} value="Login" />
                <button className={styles.createUserButton} onClick={tryLogin} value="Create Account" />
